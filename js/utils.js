...
// --- НАЧАЛО ИЗМЕНЕНИЙ: Переработана функция для масштабирования изображений ---
export function processImageFile(file, position, canvasState, redrawCallback, saveState) {
    ...
    reader.onload = (e) => {
        ...
        img.onload = () => {
            ...
            // Максимальные размеры - 90% от видимой области
            ...
            if (newWidth > maxWidth || newHeight > maxHeight) {
                ...
                // и гарантированно вписать изображение в обе стороны
