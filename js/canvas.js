...
export function initializeCanvas(
  ...
  ctx,
  redraw,
  commitChange, // Renamed from performSaveState
  updateSubToolbarVisibility,
  debouncedSaveViewState,
  debouncedCommitChange // Renamed from debouncedPerformSaveState
) {
    ...
    const callbacks = {
        ...
        saveState: commitChange, // Mapped to new function name
        updateToolbarCallback: updateSubToolbarVisibility,
        saveViewStateCallback: debouncedSaveViewState,
        debouncedPerformSaveState: debouncedCommitChange, // Mapped to new function name
    };
    ...
    const state = {
        ...
        isInteracting: false,
        saveState: commitChange, // Ensure state has access to the correct function
    };
