...
const helpContent = {
    ...
    "tools-panel": `
        ...
        <ul>
            ...
            <li><span class="keys"><b>Кривая</b></span><span>Создается по точкам. Кликните несколько раз, чтобы создать узлы. Нажмите <kbd>Enter</kbd> для завершения. Позже каждый узел и его направляющие можно будет редактировать.</span></li>
