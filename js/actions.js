...
export function handleScale(state, pos, event) {
    ...
    state.selectedLayers.forEach((layer, index) => {
        ...
        const newLayerProps = {
            ...
            rx: (originalLayer.rx ?? originalLayer.r) * scaleX,
            ry: (originalLayer.ry ?? originalLayer.r) * scaleY,
        };
        ...
        else if (layer.type === 'sphere') { Object.assign(layer, { cx: newLayerProps.cx, cy: newLayerProps.cy, r: newLayerProps.rx }); }
        ...
        else if (layer.type === 'truncated-sphere') { Object.assign(layer, { cx: newLayerProps.cx, cy: newLayerProps.cy, r: newLayerProps.rx, cutY: finalBoxTopLeft.y + (originalLayer.cutY - oBox.y) * scaleY, cutR: originalLayer.cutR * scaleX, cutRy: originalLayer.cutRy * scaleY }); }
...
// --- НАЧАЛО ИЗМЕНЕНИЙ: Добавляем примагничивание к сетке ---
