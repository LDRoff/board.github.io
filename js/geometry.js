...
// --- НАЧАЛО ИЗМЕНЕНИЙ: Исправляем формулу вращения ---
// Стандартная формула для вращения ПРОТИВ часовой стрелки.
// Canvas API ctx.rotate() вращает ПО часовой, поэтому для соответствия
// мы должны использовать отрицательный угол в вычислениях. 
// Эта функция теперь реализует стандартную математическую формулу,
// а в функциях hitTest мы передаем `-rotation`, чтобы симулировать "разворот".
