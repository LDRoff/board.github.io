...
document.addEventListener('DOMContentLoaded', () => {
    const loader = document.getElementById('loader-overlay'); // --- ДОБАВЛЕНО: Получаем элемент загрузчика
    ...
    // --- НАЧАЛО ИЗМЕНЕНИЙ: Скрываем анимацию загрузки после инициализации ---
    if (loader) {
        loader.classList.add('hidden');
        // Удаляем элемент после завершения анимации, чтобы он не мешал
