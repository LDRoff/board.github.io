...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function commitChange(change) {
        // --- НАЧАЛО ИЗМЕНЕНИЙ ---
        if (canvasState) {
            canvasState.isBBoxCacheDirty = true;
        }
        // --- КОНЕЦ ИЗМЕНЕНИЙ ---
    ...
    /**
     * Отложенная функция для сохранения состояния вида (pan/zoom) в БД.
     * Она не создает записей в истории, а напрямую вызывает
     * планировщик сохранения из модуля history.
     */
