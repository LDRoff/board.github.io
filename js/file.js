...
// --- НАЧАЛО ИЗМЕНЕНИЙ: Импортируем утилиту для обработки изображений ---
import { processImageFile } from './utils.js';
// --- КОНЕЦ ИЗМЕНЕНИЙ ---
...
export function initializeFileHandlers(canvasState, loadState, redrawCallback, saveState) {
    ...
    // --- НАЧАЛО ИЗМЕНЕНИЙ: Добавляем обработчик для загрузки изображений ---
    ...
    imageUploadInput.addEventListener('change', (e) => {
        ...
        // Рассчитываем центральную позицию видимой области холста
        const centerPos = {
